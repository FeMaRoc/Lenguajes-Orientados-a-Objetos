...
emp1.apellidoPaterno = input("Apelldio paterno del empleado 1: ")
emp1.salarioMensual = int(input("Salario mensual del empleado 1: "))
...
emp2.apellidoPaterno = input("Apelldio paterno del empleado 2: ")
emp2.salarioMensual = int(input("Salario mensual del empleado 2: "))

if emp2.salarioMensual < 0.0:
    emp2.salarioMensual = 0.0
    
print("\n--- SALARIOS ANUALES INICIALES ---")
print(f"Empleado: {emp1.primerNombre} {emp1.apellidoPaterno}\nSalario: ${emp1.obtenerSalarioAnual()}")
print(f"Empleado: {emp2.primerNombre} {emp2.apellidoPaterno}\nSalario: ${emp2.obtenerSalarioAnual()}")
